...
xxim.popchat = function(param){
    ...
    log.html = '<div class="layim_chatbox" id="layim_chatbox">'
            ...
            +'        <a href="" target="_blank" class="layim_seechatlog"><i class="fa fa-common-o"></i>聊天记录</a>'
            +'    </div>'
...
xxim.view = (function(){
    var xximNode = xxim.layimNode = $('<div id="xximmm" class="xxim_main">'
            ...
            +'<li class="xxim_online" id="xxim_online">'
                ...
                +'</div>'
            +'</li>'
            +'<li class="xxim_mymsg" id="xxim_mymsg" title="我的私信"><i class="fa fa-common"></i><a href="'+ config.msgurl +'" target="_blank"></a></li>'
