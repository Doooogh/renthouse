...
(function ($) {
    ...
    */      
    ...
    '<div><div class="editable-input"></div><span id="num">0</span>/69<div class="editable-buttons"></div></div>'+
...
@final
@example
<a href="#" id="comments" data-type="textarea" data-pk="1">awesome common!</a>
<script>
$(function(){
    $('#comments').editable({
        url: '/post',
...
(function ($) {
    ...
    Textarea.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/
        tpl:'<textarea maxlength="69" id="conNum" onkeyup="wordStatic(this);"></textarea>',
        /**
        @property inputclass
        @default input-large
        **/
